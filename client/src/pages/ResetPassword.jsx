...
const ResetPassword = () => {
   ...
   const onSubmitNewPassword = async (e) => {
      e.preventDefault();
      try {
         const { data } = await axios.post(backendUrl + "/api/auth/reset-opt", {
            email,
            otp,
            newPassword,
         });
      ...
      <div className="flex items-center justify-center min-h-screen sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400">
         ...
         {!isOtpSubmitted && isEmailSend && (
            ...
            >
               ...
               <button className="w-full py-2.5 bg-gradient-to-r from-indigo-500 to to-indigo-900 text-white rounded-full">
                  Submit
               </button>
            </form>
         )}
